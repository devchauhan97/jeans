...
<head>
    ...
    <title>Bombayport | <?php echo e($pageTitle); ?></title>
    <?php else: ?>
	...
	<link href="<?php echo asset('public/css/jquery-ui.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
	 <link rel="shortcut icon" href="http://bombayport.xyz/public/images/fab_icon.jpg" />
	<link rel="stylesheet" type="text/css" href="<?php echo asset('public/css/infinite-slider.css'); ?>">
