                                        ...
                                        <tbody>
                                            ...
                                            <?php if(count($result['orders']) > 0): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="price"><span><?php echo e($result['orders'][0]->currency); ?><?php echo e($products->final_price+0); ?></span></td>
                                                    <td align="right" class="Qty"><span><?php echo e($products->products_quantity); ?></span></td>
                                                
                                                    <td align="right" class="subtotal"><span><?php echo e($result['orders'][0]->currency); ?><?php echo e($products->products_quantity*$products->final_price+0); ?></span>
                                                    </td>
                                                </tr>    
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>				
