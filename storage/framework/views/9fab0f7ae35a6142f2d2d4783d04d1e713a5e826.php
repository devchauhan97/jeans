 	...
 	<form enctype="multipart/form-data" name="filters" method="get">
        ...
        <div class="card">
          ...
          if(!empty($result['filter_attribute']['option_values']) and in_array($values['value_id'],$result['filter_attribute']['option_values'])) print 'checked';
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
             <?php if(count($result['filters']['brand'])>0): ?>
               
            <div class="block">
                    <div class="card-title <?php if(count($result['filters']['brand'])==$key+1): ?> last <?php endif; ?>">Brand</div>
                    <div class="card-body">
                        <ul class="list">
                            <?php $__currentLoopData = $result['filters']['brand']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$attr_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <div class="form-check">
           <label class="form-check-label"> 
            <input class="form-check-input filters_box" name="brand[]" type="checkbox" value="<?php echo e($attr_data->manufacturers_name); ?>" <?php if(!empty($result['filter_attribute']['brand']) and in_array($attr_data->manufacturers_id,$result['filter_attribute']['brand'])) print 'checked';?>>
            <?php echo e($attr_data->manufacturers_name); ?>
