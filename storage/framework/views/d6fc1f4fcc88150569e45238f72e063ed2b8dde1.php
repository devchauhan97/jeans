...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/listingCustomers')); ?>"><i class="fa fa-users"></i> <?php echo e(trans('labels.ListingAllCustomers')); ?></a></li>
                            ...
                            <?php echo Form::open(array('url' =>'admin/updatecustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <br>
                                   ...
                                   <!-- <img src="<?php echo e(asset('').$data['customers'][0]->customers_picture); ?>" alt="" width=" 100px">-->
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <?php echo Form::text('customers_dob',  $data['customers'][0]->customers_dob, array('class'=>'form-control datepicker' , 'id'=>'customers_dob')); ?>
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="<?php echo e(URL::to('admin/listingCustomers')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                              </div>
                              <!-- /.box-footer -->
                            <?php echo Form::close(); ?>
