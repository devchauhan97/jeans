                                    ...
                                    <form name="attributes" id="add-Product-form" method="post" >
                                        ...
                                        <?php if(count($result['detail']['product_data'][0]->attributes)>0): ?>
                                            ...
                                            <div class="form-row">                                    
                                                ...
                                                <div class="form-group col-sm-4">							
                                                    ...
                                                    <div class="col-sm-12">								
                                                        <select name="<?php echo e($attributes_data['option']['id']); ?>"  class="form-control <?php echo e($attributes_data['option']['name']); ?> change_price">
                                                        <?php $__currentLoopData = $attributes_data['values']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($values_data['id']); ?>" prefix = '<?php echo e($values_data['price_prefix']); ?>'  value_price ="<?php echo e($values_data['price']+0); ?>" <?php if(count($result['cart'][0]->attributes)>0): ?> <?php if($result['cart'][0]->attributes[$key]->options_values_id==$values_data['id']): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e($values_data['value']); ?></option>											
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>								
                                                        </select>								
                                                    </div>							
                                                </div>							
                                        ...
                                        <div class="form-inline product-box">
                                            <div class="form-group Qty">	
                                                ...
                                                <label for="quantity" class="col-sm-3 col-form-label"><?php echo app('translator')->getFromJson('website.Quantity'); ?> </label>						
                                                <div class="input-group">						
                                                    <span class="input-group-btn first qtyminus">						
                                                    	<button class="btn btn-defualt " type="button">-</button>						
                                                    </span>						
                                                    <input type="text" readonly name="quantity" value="<?php echo e($result['cart'][0]->customers_basket_quantity); ?>" class="form-control qty">						
                                            ...
                                            <div class="price-box">
                                                ...
                                                <span class="total_price">
                                                    <?php echo e($web_setting[19]->value); ?><?php echo e($result['cart'][0]->customers_basket_quantity*$result['cart'][0]->final_price); ?>
                                            ...
                                            <div class="buttons">
                                                ...
                                                <?php else: ?>
                                                    <button class="btn btn-secondary btn-round update-single-Cart" type="button" products_id="<?php echo e($result['detail']['product_data'][0]->products_id); ?>"><?php echo app('translator')->getFromJson('website.Update'); ?></button>
                                                <?php endif; ?> 
                                            </div>					
                                    	</div>	
									</form>
