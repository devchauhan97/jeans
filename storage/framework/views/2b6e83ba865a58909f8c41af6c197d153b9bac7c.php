                          ...
                          <?php endif; ?>
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateproduct', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <?php if(!empty($result['mainCategories'][0]->parent_id)): ?>
                                	<?php echo Form::hidden('old_category_id',  $result['mainCategories'][0]->parent_id, array('class'=>'form-control', 'id'=>'old_category_id')); ?>

                                <?php endif; ?>
                                
                                <?php if(!empty($result['subCategoryId'][0]->categories_id)): ?>
                                	<?php echo Form::hidden('old_sub_category_id',  $result['subCategoryId'][0]->categories_id, array('class'=>'form-control', 'id'=>'old_sub_category_id')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-8">                                     
                                        <textarea  id="editor<?=$description_data['languages_id']?>" name="products_description_<?=$description_data['languages_id']?>" class="form-control" rows="5"><?php echo e($description_data['products_description']); ?></textarea>
                              ...
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <img src="<?php echo e(getFtpImage($result['product'][0]->products_image)); ?>" alt="" width=" 100px">
                                  </div>
                                </div>
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="<?php echo e(URL::to('admin/products')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                              </div>
