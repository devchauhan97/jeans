                    ...
                    <a href="<?php echo e(URL::to("admin/vieworder")); ?>/<?php echo e($unseenOrder->orders_id); ?>">
                      <div class="pull-left">
                         ...
                         <?php if(!empty($unseenOrder->customers_picture)): ?>
                            <img src="<?php echo e(getFtpImage($unseenOrder->customers_picture)); ?>" class="img-circle" alt="<?php echo e($unseenOrder->customers_name); ?> Image">
                            <?php else: ?>
                            <img src="<?php echo e(asset('').'/default_images/user.png'); ?>" class="img-circle" alt="<?php echo e($unseenOrder->customers_name); ?> Image">
                         <?php endif; ?>
                    ...
                    <a href="<?php echo e(URL::to("admin/editcustomers")); ?>/<?php echo e($newCustomer->customers_id); ?>">
                      <div class="pull-left">
                         <?php if(!empty($newCustomer->customers_picture)): ?>
                            <img src="<?php echo e(getFtpImage($newCustomer->customers_picture)); ?>" class="img-circle">
                            <?php else: ?>
                            <img src="<?php echo e(asset('').'/default_images/user.png'); ?>" class="img-circle" alt="<?php echo e($newCustomer->customers_firstname); ?> Image">
                         <?php endif; ?>
                      </div>
                      <h4>
                ...
                <?php $__currentLoopData = $lowInQunatity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lowInQunatity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li><!-- start message -->
                    <a href="<?php echo e(URL::to("admin/editProduct")); ?>/<?php echo e($lowInQunatity->products_id); ?>">
                      <div class="pull-left">                         
                         <img src="<?php echo e(getFtpImage($lowInQunatity->products_image)); ?>" class="img-circle" >
                      </div>
